...
void Task3code(void *pvPara){
  while(1){
  if (counter == 0){
      vTaskSuspend(Task3); // Tạm dừng Task 3 
    }
   readDS1307();
   vTaskDelay(200);
  }
...
void setup() {
 ...
 /* Display.begin();
  ...
  //xTaskCreatePinnedToCore(Task3code,"Task3",16384,NULL,2,&Task3,0);  
  xTaskCreatePinnedToCore(Task1code,"Task1",8000,NULL,1,&Task1,0); 
  xTaskCreatePinnedToCore(Task2code,"Task2",8000,NULL,1,&Task2,1); 
  xTaskCreatePinnedToCore(Task3code,"Task3",8000,NULL,1,&Task3,0);  
}
void loop() {
}